      subroutine fitsars(epi, gamaEpi,wght,nparam,
...
!
      ...
      call RK4SARS(ndata,ndays,nstep,tps,
     $           nparam,curpars,dsdt)
...
!! End of generating profiles
      ...
      end subroutine fitsars

! ------------------------------------------------------------------------

      subroutine RK4SARS(ndata,ndays,nstep,tps,
     $     nparam,curpars,dsdt)
